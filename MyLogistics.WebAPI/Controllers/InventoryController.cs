...
namespace MyLogistics.WebAPI.Controllers
{
    ...
    public class InventoryController : ControllerBase
    {
        ...
        {
            var item = await _inventoryService.GetInventoryItemByIdAsync(id, ct);
        ...
        {
            var items = await _inventoryService.GetInventoryByWarehouseAsync(warehouseId, ct);
            return Ok(items);
        }
        ...
        {
            var updated = await _inventoryService.UpdateStockAsync(id, dto, ct);
        ...
        {
            var deleted = await _inventoryService.DeleteInventoryItemAsync(id, ct);
